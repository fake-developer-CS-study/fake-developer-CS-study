...
Q3. 멀티프로세스와 멀티프로세싱의 차이란?

→ 전혀 다른 것이다. 

멀티 프로세싱: 다수의 프로세서가 서로 협력적으로 일을 처리하는 것을 의미한다. 멀티 프로세싱에는 멀티 코어시스템도 포함하고 있다. 
멀티 프로세스: 하나의 응용프로그램을 여러 개의 프로세스로 구성하여 각 프로세스가 하나의 작업을 처리하도록 하는 것이다.
